...
public class AdMobAds : MonoBehaviour
{
    ...
    public void _RequestInterstial()
    {
#if UNITY_ANDROID
        string INTERSTIALID = "ca-app-pub-3940256099942544/1033173712";
#elif UNITY_IPHONE
    ...
    public void _RequestRewardedAd()
    {
        string REWARDEDADID;
#if UNITY_ANDROID
    ...
    public void HandleRewardedAdLoaded(object sender, EventArgs args)
    {
        ...
        m_status.text = "REWARDED AD LODED";
    }
    ...
    public void HandleRewardedAdFailedToLoad(object sender, AdErrorEventArgs args)
    {
        MonoBehaviour.print(
            "HandleRewardedAdFailedToLoad event received with message: "
                             + args.Message);
        m_status.text = "REWARDED AD FAILED TO LODED";
    }
    ...
    public void HandleRewardedAdClosed(object sender, EventArgs args)
    {
        ...
        m_status.text = "REWARDED AD CLOSED";
    }
